...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    if (commentInput) {
        commentInput.addEventListener('input', (ev) => __awaiter(this, void 0, void 0, function* () { cinf(); }));
        cinf();
    }
    /**
     * @param {Event} ev
     */
    const editEvent = (ev) => __awaiter(this, void 0, void 0, function* () {
        ev.preventDefault();
        ev.stopPropagation();
        ...
        if (!_data)
            return RSNotifications.create('Comment not found.', 'error');
        ...
        const revert = (text) => {
            ...
            (_a = _footer.querySelector('a[href="#edit"]')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', editEvent);
            (_b = _footer.querySelector('a[href="#delete"]')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', deleteEvent);
        };
        const cancel = d.createElement('a');
        cancel.setAttribute('href', 'javascript:void(0)');
        cancel.setAttribute('role', 'button');
        cancel.innerText = 'Cancel';
        cancel.addEventListener('click', (ev) => __awaiter(this, void 0, void 0, function* () {
            ev.preventDefault();
            ev.stopPropagation();
        ...
        cancel.setAttribute('role', 'button');
        save.innerText = 'Save';
        save.addEventListener('click', (ev) => __awaiter(this, void 0, void 0, function* () {
            ev.preventDefault();
            ev.stopPropagation();
            ...
            if (cont.length === 0)
                return RSNotifications.create('Comment cannot be empty.', 'warning');
            if (cont.length > 250)
                return RSNotifications.create('Comment cannot be longer than 250 characters.', 'warning');
            if (_data.edits.length >= 5)
                return RSNotifications.create('You cannot edit this comment anymore.', 'warning');
            try {
                const res = yield fetch(form.getAttribute('action'), {
                    method: 'POST',
     ...
     * @param {Event} ev
     */
    const deleteEvent = (ev) => __awaiter(this, void 0, void 0, function* () {
        ev.preventDefault();
        ev.stopPropagation();
        /**
         * @type {HTMLElement}
        ...
        if (!_data)
            return RSNotifications.create('Comment not found.', 'error');
        try {
            const res = yield fetch(`${endpoint}/${_data.id}`, {
                method: 'DELETE',
    ...
    function loadComments() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const res = yield fetch(`${endpoint}/${page}`, { 'method': 'GET' });
                if (res.ok) {
    ...
    (_a = d.getElementById('shoutout-form')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', (ev) => __awaiter(this, void 0, void 0, function* () {
