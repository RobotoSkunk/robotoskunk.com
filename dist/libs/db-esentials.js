...
exports.mailer = new mailer_1.Mailer({
    host: globals_1.conf.emails.noreply.host,
    port: globals_1.conf.emails.noreply.port,
    secure: globals_1.conf.emails.noreply.secure,
    auth: {
        user: globals_1.conf.emails.noreply.auth.user,
        pass: globals_1.conf.emails.noreply.auth.pass
    }
}, globals_1.logger, globals_1.conf.production ? mailer_1.Mailer.Mode.Internal : mailer_1.Mailer.Mode.Debug, globals_1.conf.root, conn_1.pgConn, globals_1.conf.keys.MASTER);
class Email {
    ...
    GetUser() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (u)
                    return resolve(u);
                reject(new RSEngine_1.RSError('User not found', 404));
            }));
        });
    }
    /**
    ...
    static Validate(email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const data = (yield readFile(path_1.default.join(process.cwd(), 'disposable_email_blocklist.conf'), 'ascii')).replace('\r\n', '\n');
    ...
    static HMAC(email) { return RSEngine_1.RSCrypto.HMAC(email + globals_1.conf.keys.SALT, globals_1.conf.keys.HMAC); }
    static Exists(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield conn_1.pgConn.connect();
            try {
    ...
    Send(type, ...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function verifyLink(token) { return `${globals_1.conf.root}/verify-email/${token}`; }
            const contactLink = `${globals_1.conf.root}/contact`;
            try {
                var body, subject;
                switch (type) {
                    case Email.MailType.NEW_USER: {
                        ...
                        const valHash = RSEngine_1.RSCrypto.HMAC(validator, globals_1.conf.keys.HMAC);
                    ...
                    case Email.MailType.PASSWORD_RESET_REQUEST: {
						...
						<p><a href="${globals_1.conf.root}/accounts/change-password?token=${token}">${globals_1.conf.root}/accounts/change-password?token=${token}</a>
...
class Token {
    ...
    static HMAC(secret) { return RSEngine_1.RSCrypto.HMAC(secret, globals_1.conf.keys.HMAC); }
    Validate(validator) {
...
class UserToken extends Token {
    ...
    static Set(uid, remember, useragent, verified) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const id = RSEngine_1.RSCrypto.RandomBytes(16);
                const validator = RSEngine_1.RSCrypto.RandomBytes(32);
                const browser = RSEngine_1.RSMisc.AnonymizeAgent(useragent);
                const _res = yield client.query(`INSERT INTO auth_tokens (id, usrid, client, val_key, is_temp, expires_at, verified) VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP + INTERVAL '1 ${remember ? 'WEEK' : 'HOUR'}', $6) RETURNING created_at, expires_at, last_usage, last_update`, [
                    ...
                    uid,
                    browser,
                    RSEngine_1.RSCrypto.HMAC(validator, globals_1.conf.keys.HMAC),
                    !remember,
                    verified
                ]);
                return {
                    token: new UserToken(id, RSEngine_1.RSCrypto.HMAC(validator, globals_1.conf.keys.HMAC), _res.rows[0].created_at, _res.rows[0].expires_at, browser, uid, _res.rows[0].last_usage, _res.rows[0].lastUpdate, !remember, verified),
                    text: `${id}.${validator}`
                };
            }
            catch (e) {
                ...
                try {
                    ...
                    if (tok.lastUpdate.getTime() < Date.now() - RSEngine_1.RSTime._HOUR_) {
                        ...
                        yield client.query(`UPDATE auth_tokens SET val_key = $1, last_update = CURRENT_TIMESTAMP, client = $2 WHERE id = $3`, [
                            ...
                            RSEngine_1.RSMisc.AnonymizeAgent(userAgent),
                            id
                        ]);
    ...
    GetCookieParams(isOnion) {
        return {
            ...
            path: '/',
            secure: globals_1.conf.production && !isOnion,
            httpOnly: true,
            sameSite: 'lax',
            domain: isOnion ? undefined : (globals_1.conf.production ? `.${globals_1.conf.domain}` : 'localhost')
        };
    }
    Destroy() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    GenerateCSRF() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield client.query(`UPDATE auth_tokens SET _csrf = $1 WHERE id = $2`, [RSEngine_1.RSCrypto.HMAC(csrf, globals_1.conf.keys.HMAC), this.id]);
                return csrf;
            }
            catch (e) {
                globals_1.logger.error(e);
    ...
    ValidateCSRF(csrf) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return RSEngine_1.RSCrypto.Compare(_res.rows[0]._csrf, RSEngine_1.RSCrypto.HMAC(csrf, globals_1.conf.keys.HMAC));
            }
            catch (e) {
                globals_1.logger.error(e);
            }
    ...
    GenerateConfigAuth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield client.query(`UPDATE auth_tokens SET _config_auth = $1 WHERE id = $2`, [RSEngine_1.RSCrypto.HMAC(auth, globals_1.conf.keys.HMAC), this.id]);
                return auth;
            }
            catch (e) {
                globals_1.logger.error(e);
    ...
    ValidateConfigAuth(auth) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return RSEngine_1.RSCrypto.Compare(_res.rows[0]._config_auth, RSEngine_1.RSCrypto.HMAC(auth, globals_1.conf.keys.HMAC));
            }
            catch (e) {
                globals_1.logger.error(e);
            }
...
class User {
    ...
    static GenerateCryptoKey(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield RSEngine_1.RSCrypto.PBKDF2(globals_1.conf.keys.MASTER, hash, 1000, 32);
        });
    }
    GetCryptoKey() {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    codes.push(code);
                    hashes.push(RSEngine_1.RSCrypto.HMAC(code, globals_1.conf.keys.HMAC));
                }
    ...
    VerifyRecoveryCode(code) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const c = RSEngine_1.RSCrypto.HMAC(code, globals_1.conf.keys.HMAC);
                var found = false;
