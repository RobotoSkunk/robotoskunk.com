...
function rateLimiterMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        if (res.isApi)
            return next();
        try {
            yield exports.__rateLimiter.consume(RSEngine_1.RSCrypto.HMAC(req.ip, globals_1.env.keys.RATE_LIMITER));
            next();
        }
        catch (e) {
...
function rateLimiterBruteForce(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield exports.bruteForceLimiters.byIP.consume(RSEngine_1.RSCrypto.HMAC(req.ip, globals_1.env.keys.RATE_LIMITER));
        }
        catch (e) {
            if (!(e instanceof Error))
                __setHeaderAuto(res, e);
